...
import { WarrantyData } from "./MockData"
                            ...
                            <Grid size={{ lg: 6, md: 12, sm: 12, xs: 12 }}>
                                <Box className="cardContainer">
                                    <Box className="deviceDetails">
                                        <img src={item.img} alt="iphone" className="img" />
                                        <Box className="details">
                                            <Typography className="deviceName">{item.AssetName}</Typography>
                                            <Typography className="deviceBrand">{item.brand}</Typography>
                                        </Box>

                                    </Box>
                                    <Box className="expiryDate">
                                        <Typography className="date">{item.date}</Typography>
                                        <Typography className="deviceBrand">{item.device}</Typography>
                                    </Box>
